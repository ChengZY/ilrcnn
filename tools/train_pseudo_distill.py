...
def do_train(model_source, model_target, data_loader, optimizer, scheduler, checkpointer_source, checkpointer_target,
    ...
    for iteration, (images, targets, _, idx) in enumerate(data_loader, start_iter):
        ...
        # source model prediction as pseudo label
        ...
        pseudo_softlabel_losses = loss_dict_target['loss_softclassifier']
        ...
        if not cfg_target.MODEL.ROI_DISTILL:
        ...
        losses = faster_rcnn_losses + distillation_losses + pseudo_softlabel_losses
        ...
        if iteration % 20 == 0 or iteration == max_iter:
            ...
            summary_writer.add_scalar('classifier_loss/pseudo_softlabel_losses_avg', average_pseudo_softlabel_loss, iteration)
            summary_writer.add_scalar('classifier_loss/classifier_losses_avg', average_classifier_loss, iteration)
